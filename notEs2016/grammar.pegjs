...
blockContent		=
	block:letSetBlock			{ return { type: 'LET SET',		block: block, txt: function () {   return computeText(arguments); } }; }
	/	block:ifBlock			{ return { type: 'IF',			block: block, txt: function () {   return computeText(arguments); } }; }
	/	block:elseBlock			{ return { type: 'ELSE',		block: block, txt: function () {   return computeText(arguments); } }; }
	/	block:endBlock			{ return { type: 'END',			block: block, txt: function () {   return computeText(arguments); } }; }
	/	block:loadBlock			{ return { type: 'LOAD',		block: block, txt: function () {   return computeText(arguments); } }; }
	/	block:dropBlock			{ return { type: 'DROP',		block: block, txt: function () {   return computeText(arguments); } }; }
	/	block:renameBlock		{ return { type: 'RENAME',		block: block, txt: function () {   return computeText(arguments); } }; }
	/	block:doBlock			{ return { type: 'DO',			block: block, txt: function () {   return computeText(arguments); } }; }
	/	block:loopUntilBlock	{ return { type: 'LOOP UNTIL',	block: block, txt: function () {   return computeText(arguments); } }; }
	/	block:exitBlock			{ return { type: 'EXIT',		block: block, txt: function () {   return computeText(arguments); } }; }
	/	block:declareBlock		{ return { type: 'DECLARE',		block: block, txt: function () {   return computeText(arguments); } }; }
	/	block:deriveBlock		{ return { type: 'DERIVE',		block: block, txt: function () {   return computeText(arguments); } }; }
	/	block:forBlock			{ return { type: 'FOR',			block: block, txt: function () {   return computeText(arguments); } }; }
	/	block:nextBlock			{ return { type: 'NEXT',		block: block, txt: function () {   return computeText(arguments); } }; }
	/	block:storeBlock		{ return { type: 'STORE',		block: block, txt: function () {   return computeText(arguments); } }; }
	/	block:sleepBlock		{ return { type: 'SLEEP',		block: block, txt: function () {   return computeText(arguments); } }; }
	/	block:binaryBlock		{ return { type: 'BINARY',		block: block, txt: function () {   return computeText(arguments); } }; }
	/	block:searchBlock		{ return { type: 'SEARCH',		block: block, txt: function () {   return computeText(arguments); } }; }
	/	block:subBlock			{ return { type: 'SUB',			block: block, txt: function () {   return computeText(arguments); } }; }
	/	block:callBlock			{ return { type: 'CALL',		block: block, txt: function () {   return computeText(arguments); } }; }
	/	block:starIsBlock		{ return { type: 'STAR IS',		block: block, txt: function () {   return computeText(arguments); } }; }
	/	block:sectionBlock		{ return { type: 'SECTION',		block: block, txt: function () {   return computeText(arguments); } }; }
	/	block:commentBlock		{ return { type: 'COMMENT',		block: block, txt: function () {   return computeText(arguments); } }; }
	/	block:tagBlock			{ return { type: 'TAG',			block: block, txt: function () {   return computeText(arguments); } }; }
	/	block:qualifyBlock		{ return { type: 'QUALIFY',		block: block, txt: function () {   return computeText(arguments); } }; }
	/	block:directBlock		{ return { type: 'DIRECT',		block: block, txt: function () {   return computeText(arguments); } }; }
...
connectBlock
	= con1:connectBlockSep* head:connectBlockItem con2:connectBlockSep* tail:(connectBlockItem connectBlockSep*)* & spEndofrow
	{
		...
		return { connect: retVal, txt: function () {   return computeText(arguments); } };
	}


connectBlockItem
	= c:'CONNECT'i to:(spaces 'TO'i)?	{ return { connect: true, 		txt: function () {   return computeText(arguments); } } }
	/ c:'CUSTOM'i						{ return { connect: true, 		txt: function () {   return computeText(arguments); } } }
	/ d:'DISCONNECT'i					{ return { connect: false, 		txt: function () {   return computeText(arguments); } } }
	/ p:'PROVIDER'i						{ return { connect: undefined, 	txt: function () {   return computeText(arguments); } } }
...
directBlockFields
	...
	{ return { fields: [ head ].concat(tail ? tail.map(function(e) {return e[3];}) : []), txt: function () {   return computeText(arguments); } } }
	
directBlockField
	= src:(directBlockNative / resource) sep1:sep as:'AS'i sep2:sep res:resource
	{ return { expr: src, field: res, txt: function () {   return computeText(arguments); } }; }
	/ resource
...
directBlockNative
	...
	{ return { type: 'NATIVE', value: str, txt: function () {   return computeText(arguments); } }; }
...
subBlock
	...
	{ return { name: name, params: params, txt: function () {   return computeText(arguments); } }; }
...
searchBlock
	...
	{ return { dir: dir, fields: fields.fields, txt: function () {   return computeText(arguments); } }}
...
tagBlock
	...
	{ return { mode: 'SINGLE', resource: res, tag: tag, txt: function () {   return computeText(arguments); } } }
	/ t:'TAG'i sep1:sep f:'FIELDS'i sep2:sep res:resources sep3:sep u:'USING'i sep4:sep map:resource
	{ return { mode: 'MAP', resources: res, map: map, txt: function () {   return computeText(arguments); } } }

// COMMENT block
 
scriptCommentBlock
	= scriptComment:endofrow
	{ return { comment: scriptComment, txt: function () {   return computeText(arguments); } }}
...
letSetBlockValue
	= & (sep? variableValue spEndofrow ( EOF / block )) sep3:sep? val:variableValue	{ return { val: val, txt: function () {   return computeText(arguments); } } }
	/ val:spaces? & spEndofrow														{ return { val: val, txt: function () {   return computeText(arguments); } } }

// IF block

ifBlock				=
	e:('ELSE'i spaces?)? i:'IF'i sp1:spaces condition:expression sp2:spaces t:'THEN'i
	{ return { condition: condition, txt: function () {   return computeText(arguments); } } } 
...
loadBlockPrefix
	= prefix:tableName						{ return { table: prefix,				txt:		function () {   return computeText(arguments); } } }
	/ prefix:'MAPPING'i & sep				{ return { mapping: true,					txt:		function () {   return computeText(arguments); } } }
	/ prefix:loadBlockConcat				{ return { concat: prefix,					txt:		function () {   return computeText(arguments); } } }
	/ prefix:loadBlockJoin					{ return { join: prefix,					txt:		function () {   return computeText(arguments); } } }
	/ prefix:loadBlockInterval				{ return { interval: prefix,				txt:		function () {   return computeText(arguments); } } }
	/ prefix:loadBlockAdd					{ return { add: prefix,						txt:		function () {   return computeText(arguments); } } }
	/ prefix:loadBlockBuffer				{ return { buffer: prefix,					txt:		function () {   return computeText(arguments); } } }
	/ prefix:loadBlockBundle				{ return { bundle: prefix,					txt:		function () {   return computeText(arguments); } } }
	/ prefix:loadBlockCrosstable			{ return { crosstable: prefix,				txt:		function () {   return computeText(arguments); } } }
	/ prefix:loadBlockFirst					{ return { first: prefix,					txt:		function () {   return computeText(arguments); } } }
	/ prefix:'GENERIC'i & sep				{ return { generic: true,					txt:		function () {   return computeText(arguments); } } }
	/ prefix:loadBockHierarchy				{ return { hierarchy: prefix,				txt:		function () {   return computeText(arguments); } } }
	/ prefix:loadBockHierarchyBelongsTo		{ return { hierarchyBelongsTo: prefix,		txt:		function () {   return computeText(arguments); } } }

loadBlockConcat
	= concat:'CONCATENATE'i name:(
      	sep1:sep? op:'(' sep2:sep? name:resource sep3:sep? cp:')'		{ return { name: name, 					txt:		function () {   return computeText(arguments); } }}
        / & sep															{ return { name: false, 				txt:		function () {   return computeText(arguments); } }}
    )																{ return { concat: true, name: name.name, 	txt:		function () {   return computeText(arguments); } }}
	/ noconcat:'NOCONCATENATE'i & sep								{ return { concat: false, 					txt:		function () {   return computeText(arguments); } }}
...
loadBlockJoin
	...
	{ return { join: true, direction: dir ? dir[0] : false, name: name.name, txt: function () {   return computeText(arguments); } } }
...
loadBlockInterval
	...
	{ return { name: name, txt: function () {   return computeText(arguments); } } }
	
loadBlockAdd
	= a:'ADD'i only:(sep 'ONLY'i)? & sep
	{ return { add: true, only: (only) ? true : false, txt: function () {   return computeText(arguments); } } }
...
loadBlockBuffer
	...
	{ return { buffer: true, options: options.options, txt: function () {   return computeText(arguments); } } }
...
loadBlockBufferOption
	= i:'INCREMENTAL'i
	{ return { incremental: true, txt: function () {   return computeText(arguments); } }; }
	/ s:'STALE'i after:( sep 'AFTER'i )? sep1:sep duration:integer unit:( sep ( 'DAYS'i / 'HOURS'i ))?
	{ return { stale: true, after: (after) ? true : false, duration: duration, unit: (unit) ? unit[1] : 'DAYS', txt: function () {   return computeText(arguments); } } }
...
loadBlockFirst
	...
	{ return { first: n.n, txt: function () {   return computeText(arguments); } } }
	
loadBlockFirstN
	= sep1:sep n:integer										{ return { n: n, txt: function () {   return computeText(arguments); } } }
	/ sep1:sep? op:'(' sep2:sep? n:integer sep3:sep? cp:')'		{ return { n: n, txt: function () {   return computeText(arguments); } } }
...
loadBockHierarchyResSep
	= res:resource s:sep?
	{ return { res: res, txt: function () {   return computeText(arguments); } }}
	
loadBockHierarchyResSepComma
	= c:',' s:sep? res:loadBockHierarchyResSep?
	{ return { res: res ? res.res : false, txt: function () {   return computeText(arguments); } }}
...
loadBlockSourceFromParam
	= d:'delimiter'i sp1:spaces i:'is'i sp2:spaces delim:resource				{ return { delimiter: true, value: delim.value,	txt: function () {   return computeText(arguments); } }; }
	/ t:'table'i sp1:spaces 'is'i sp2:spaces table:resource						{ return { table: true, value: table.value,		txt: function () {   return computeText(arguments); } }; }
...
loadBlockSuffix
	= suffix:'WHILE'i s1:sep exprWhile:expression										{ return { while: exprWhile, 				txt: function () {   return computeText(arguments); } }}
	/ suffix:'WHERE'i s1:sep exprWhere:expression										{ return { where: exprWhere, 				txt: function () {   return computeText(arguments); } }}
	/ suffix:'GROUP'i s1:spaces b:'BY'i s2:sep groupbyFields:loadBlockGroupByFields		{ return { groupby: groupbyFields.fields, 	txt: function () {   return computeText(arguments); } }}
	/ suffix:'ORDER'i s1:spaces b:'BY'i s2:sep orderbyFields:loadBlockOrderByFields		{ return { orderby: orderbyFields.fields, 	txt: function () {   return computeText(arguments); } }}
...
renameBlockFromToSepComma
	...
	{ return { fromTo: fromTo, txt: function () {   return computeText(arguments); } }}
  
renameBlockFromTo
	= from:resource s1:sep t:'TO'i s2:sep to:resource
	{ return { from: from, to: to, txt: function () {   return computeText(arguments); } }}

// DO block

doBlock
	= 'DO'i w:doBlockWhile?
	{ return { while: w ? w.expr : false, txt: function () {   return computeText(arguments); } }}
	
doBlockWhile
	= s1:sep w:'WHILE'i s2:sep expr:expression
	{ return { expr: expr, txt: function () {   return computeText(arguments); } }}
...
conditionORExpression
	= head:conditionANDExpression tail:(sep? conditionOROperator sep? conditionANDExpression)*
	{
		if (tail.length == 0) {
			...
			retVal.txt = function () {   return computeText(arguments); };
			return retVal;
		}
    }
...
comparisonExpression
	= left:calculationExpression sep? op:comparisonOperator sep? right:calculationExpression {
		return { type: 'EXPR', op: op, left: left, right: right, txt: function () {   return computeText(arguments); } }
    }
...
termExpression
	= op:"(" sp1:sep? expr:expression sp2:sep? cp:")"		{ return { type: 'EXPR', op: false, left: expr, right: false, 	txt: function () {   return computeText(arguments); } }; }
	/ expr:number											{ return { type: 'NUM', value: expr, 							txt: function () {   return computeText(arguments); } }; }	
	/ expr:singleQuoteString								{ return expr; }
	/ expr:functionCall										{ return expr; }
	/ expr:('TRUE'i / 'FALSE'i)								{ return { type: 'BOOL', value: expr, 							txt: function () {   return computeText(arguments); } }; }
	/ expr:resource											{ return { type: 'VAR', value: expr.value, 						txt: function () {   return computeText(arguments); } }; }
	/ expr:('$' [0-9])										{ return { type: 'PARAM', value: expr, 							txt: function () {   return computeText(arguments); } }; }

functionCall		= 	name:functionName sp1:sep? op:'(' sp2:sep? d:'DISTINCT'i? sp3:sep? params:functionParameters? sp4:sep? cp:')'
						{ return { type: "FCALL", function: name, params: params, txt: function () {   return computeText(arguments); } }; }
...
resource			= name:(
						lib:'lib://' res:[^ \t\r\n()]+		{ return { value: lib + res.join(''), 					txt: function () {   return computeText(arguments); } }; }
						/ name:('@'? alphanum)				{ return { value: (name[0] ? name[0] : '') + name[1], 	txt: function () {   return computeText(arguments); } }; }
...
doubleQuoteString
	...
	{
		return { type: 'STR', value: chars.map(function(char)  { return char.char;}).join(''), txt: function () {   return computeText(arguments); } };
	}

doubleQuotechar
 	= char:doubleQuoteUeChar
	{ return { char: char, txt: function () {   return computeText(arguments); } }}
	
	/ esc:doubleQuote sequence:(doubleQuote)
    { return { char: sequence, txt: function () {   return computeText(arguments); } }; }
	
    / sep:sep char:(doubleQuotechar / & doubleQuote)
    { return { char: sep + char, txt: function () {   return computeText(arguments); } }; }
